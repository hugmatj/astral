<template>
  <div
    class="
      ...
      cursor-text
      focus-within:border-indigo-500 focus-within:ring-indigo-100
    "
    @click.stop
  >
    <ul class="relative flex flex-wrap items-center w-full">
      ...
      <li
        class="relative flex-grow mx-1 mb-2 leading-none isolate"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    let inputRect = reactive<
      Pick<Record<keyof DOMRect, number>, 'top' | 'left' | 'height'>
    >({
      top: 0,
      left: 0,
      height: 20,
