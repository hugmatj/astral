        ...
        >
          ...
          >
            ...
            >
              ...
              <span class="inline-block mx-2 text-xs font-bold text-gray-300"
                >|</span
              >
...
const userStar = computed(
  () => starsStore.userStarsByRepoId[starsStore.selectedRepo.databaseId]
)
...
watch(
  ...
  () => {
    ...
    editor.value?.commands.setContent(
      Object.keys(notes).length ? notes : '<p></p>'
    )
