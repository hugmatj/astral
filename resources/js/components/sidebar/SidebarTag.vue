...
import { StarDragDataTransferData, Tag } from '@/types'
            ...
            >
              <div class="py-1">
                <MenuItem v-slot="{ active }">
                  <button
                    class="group-one flex w-full items-center p-2 text-xs font-semibold"
                    :class="[active ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700']"
                    @click.stop="showRenameTagDialog(tag)"
                  >
                    <PencilAltIcon
                      class="mr-1 h-4 w-4 text-gray-400 group-one-hover:text-indigo-500"
                      aria-hidden="true"
                    />
                ...
                <MenuItem v-slot="{ active }">
                  ...
                  >
                    <TrashIcon class="mr-1 h-4 w-4 text-gray-400 group-one-hover:text-indigo-500" aria-hidden="true" />
