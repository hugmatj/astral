            ...
            <div class="divide-y divide-gray-300">
              ...
              <div class="px-4 py-5">
                <div class="flex items-center">
                  ...
                  <BaseButton
                    ...
                    kind="danger"
                    size="sm"
                    @click="Inertia.post('/revoke-grant')"
                    >Revoke Access</BaseButton
                  >
                </div>
                <p class="mt-4 text-sm text-gray-500">
                  This will log you out and revoke your authorization granted to
                  Astral for accessing your GitHub account. You will not lose
                  any data.
                </p>
              </div>
              ...
              <div class="px-4 py-5">
                <div class="flex items-center">
                  ...
                  <div class="flex items-center ml-auto space-x-3">
                    <div v-show="isRequestingDeleteConfirmation">
                      <label for="confirm-user-delete" class="sr-only"
                ...
                <p class="mt-4 text-sm text-gray-500">
                  ...
                  on this site, and revoke your authorization granted to Astral.
                  <em>Be careful!</em>
                </p>
              </div>
            </div>
...
const deleteButtonLabel = computed(() =>
  isRequestingDeleteConfirmation.value
    ? 'Confirm Deletion'
    : 'Delete My Account'
)
...
const deleteButtonIsDisabled = computed(() => {
  return (
    isRequestingDeleteConfirmation.value &&
    usernameConfirmation.value !== userStore.user?.username
  )
})
