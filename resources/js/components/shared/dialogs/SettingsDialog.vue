    ...
    <Dialog as="div" static class="fixed inset-0 z-20 overflow-y-auto" :open="isOpen" @close="hide">
      <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
          <div class="inline-block w-full max-w-sm overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-xl">
            <DialogTitle class="w-full px-4 py-3 font-bold text-gray-700 bg-gray-100 border-b border-gray-200 rounded-t-lg">Settings</DialogTitle>
            <div class="divide-y divide-gray-300">
              ...
              <div class="px-4 py-5">
                <div class="flex items-center">
                  ...
                  <BaseButton class="ml-auto" kind="danger" size="sm" @click="Inertia.post('/revoke-grant')">Revoke Access</BaseButton>
                </div>
                <p class="mt-4 text-sm text-gray-500">This will log you out and revoke your authorization granted to Astral for accessing your GitHub account. You will not lose any data.</p>
              </div>
              ...
              <div class="px-4 py-5">
                ...
                <p class="mt-4 text-sm text-gray-500">This will permanently delete <strong>all</strong> of your data on this site, and revoke your authorization granted to Astral. <em>Be careful!</em></p>
              </div>
            </div>
          </div>
        </TransitionChild>
...
<script setup lang="ts">
  ...
  const deleteButtonLabel = computed(() => isRequestingDeleteConfirmation.value ? 'Confirm Deletion' : 'Delete My Account')
