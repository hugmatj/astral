              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm leading-6 text-gray-500">
                    Unstarring repositories requires your authorization scope to
                    be upgraded from
                    <code
                      class="
                        inline-flex
                    ...
                    <code
                      ...
                      "
                      >public_repo</code
                    >. If you would like to learn more about authorization
                    scopes, you can consult the
                    <a
