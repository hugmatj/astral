              ...
              <div>
                <div class="mt-3 text-center sm:mt-5">
                  <div class="mt-2">
                    ...
                    <input id="tagName" v-model="form.name" type="text" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-brand-500 focus:border-brand-500 sm:text-sm" placeholder="Enter a name for your tag" />
                    <p v-if="form.errors.name" class="mt-2 text-xs text-left text-red-500">{{ form.errors.name }}</p>
                  </div>
                </div>
              </div>
