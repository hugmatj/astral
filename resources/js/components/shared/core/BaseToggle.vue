<template>
  ...
  >
    ...
    >
      <span
        :class="[
          enabledState ? 'opacity-0 ease-out duration-100' : 'opacity-100 ease-in duration-200',
      ...
      <span
        :class="[
          enabledState ? 'opacity-100 ease-in duration-200' : 'opacity-0 ease-out duration-100',
          'absolute inset-0 h-full w-full flex items-center justify-center transition-opacity',
        ]"
        aria-hidden="true"
      >
