...
var fetchStarsQuery = function fetchStarsQuery() {
  ...
  var direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _types__WEBPACK_IMPORTED_MODULE_0__.FetchDirections.DESC;
...
/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/queries */ "./resources/js/queries/index.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/types */ "./resources/js/types/index.ts");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            direction = data.direction || _types__WEBPACK_IMPORTED_MODULE_2__.FetchDirections.DESC;
            _context.next = 5;
            return fetch('https://api.github.com/graphql', {
              ...
              body: JSON.stringify({
                query: (0,_queries__WEBPACK_IMPORTED_MODULE_1__.fetchStarsQuery)(cursor, direction)
              })
            });
