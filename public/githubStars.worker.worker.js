...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/constants */ "./resources/js/constants.ts");

var fetchStarsQuery = function fetchStarsQuery() {
  var cursor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _constants__WEBPACK_IMPORTED_MODULE_0__.FETCH_DIRECTIONS.DESC;
...
"use strict";
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/ts-loader/index.js??clonedRuleSet-6!./resources/js/workers/githubStars.worker.ts ***!
  \************************************************************************************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/constants */ "./resources/js/constants.ts");
/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/queries */ "./resources/js/queries/index.ts");
...
self.addEventListener('message', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(_ref) {
    var data, cursor, direction, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            direction = data.direction || _constants__WEBPACK_IMPORTED_MODULE_1__.FETCH_DIRECTIONS.DESC;
            _context.next = 5;
            return fetch('https://api.github.com/graphql', {
              ...
              body: JSON.stringify({
                query: (0,_queries__WEBPACK_IMPORTED_MODULE_2__.fetchStarsQuery)(cursor, direction)
              })
            });
